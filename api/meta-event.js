...
export default async function handler(req, res) {
  ...
  try {
    const { email, phone, first_name, last_name, value, event_id, event_name, pixel_id, fbp, fbc, page_url } = req.body;
      ...
      data: [
        {
          ...
          event_source_url: page_url || req.headers.referer || "https://elarisdigitalsolutions.com",
          user_data: {
