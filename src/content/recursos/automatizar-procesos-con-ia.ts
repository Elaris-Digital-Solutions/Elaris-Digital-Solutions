  ...
  faq: [
    {
      ...
      a: "Depende del proceso y el volumen, pero un primer caso acotado es una inversión de semanas, no de meses. La forma seria de saberlo es un diagnóstico del proceso concreto — el nuestro no tiene costo.",
    },
    {
