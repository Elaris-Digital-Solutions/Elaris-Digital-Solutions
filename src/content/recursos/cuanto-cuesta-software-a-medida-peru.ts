...
export const article: Article = {
  slug: "cuanto-cuesta-software-a-medida-peru",
  title: "¿Cuánto cuesta desarrollar un software a medida en Perú? Guía honesta de precios",
  seoTitle: "¿Cuánto Cuesta un Software a Medida en Perú? [Guía 2026]",
  seoDescription:
    "Rangos reales del mercado peruano para desarrollar software a medida, qué determina el precio y cómo evitar los costos ocultos del software barato.",
  publishDate: "2026-08-03",
  modifiedDate: "2026-08-03",
  authorSlug: "carlos-colfer",
  servicePath: "/desarrollo-software-medida",
  ...
  sections: [
    ...
    },
    {
      ...
      list: [
        ...
        "Hora de desarrollo freelance: S/ 40 – S/ 120 · Hora de agencia o estudio: S/ 120 – S/ 350",
      ],
    },
    {
  ...
  faq: [
    {
      q: "¿Cuánto cuesta un software a medida sencillo en Perú?",
      a: "Un módulo o automatización puntual bien especificada se cotiza en el mercado peruano entre S/ 8,000 y S/ 25,000 aproximadamente. Por debajo de eso, revisa con lupa qué está incluido: pruebas, documentación y garantía suelen ser lo primero que se recorta.",
    },
    {
      q: "¿El diagnóstico de Elaris tiene costo?",
      a: "No. El diagnóstico técnico y operativo es gratuito y toma dos semanas. Te entregamos un informe con la ruta de desarrollo y los costos estimados antes de que inviertas.",
    },
    {
      q: "¿Es más barato contratar un freelance?",
      a: "Por hora, sí. Por resultado, depende: para proyectos pequeños y bien definidos un buen freelance funciona; para sistemas de los que va a depender tu operación, el costo de que algo falle sin soporte suele superar el ahorro.",
    },
    {
