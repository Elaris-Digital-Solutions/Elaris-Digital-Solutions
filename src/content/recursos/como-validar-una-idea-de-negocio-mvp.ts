  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "En ambos escenarios ganaste lo mismo: certeza barata. Y si el producto despega, el requisito silencioso se vuelve crítico: que la primera versión haya sido construida para soportar la segunda. Pregunta por eso antes de contratar a quien te lo construya, porque te ahorrará rehacer todo en el peor momento posible.",
      ],
    },
  ],
  faq: [
