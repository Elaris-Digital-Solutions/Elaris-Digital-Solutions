...
export const article: Article = {
  slug: "cuanto-cuesta-una-pagina-web-peru",
  ...
  seoDescription:
    "Rangos de precio reales del mercado peruano para páginas web: plantillas, freelance, agencias y desarrollo a medida. Qué incluye (y qué no) cada opción.",
  publishDate: "2026-08-03",
  modifiedDate: "2026-08-03",
  authorSlug: "sergio-herrera",
  servicePath: "/desarrollo-web",
  ...
  sections: [
    {
      ...
      paragraphs: [
        "Lo que sigue son referencias del mercado peruano: sirven para que compares propuestas con criterio.",
      ],
      list: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "La agencia o estudio compra diseño a tu marca, proceso y alguien que responde. Las diferencias grandes dentro del rango están en lo invisible: velocidad de carga, base técnica para Google y autonomía para editar tu propio contenido.",
        "El desarrollo a medida compra que el sitio haga cosas: catálogo administrable, cotizadores, reservas, integraciones con tus sistemas. Aquí ya no estás comprando una página, sino una [herramienta de venta construida para tu operación](/desarrollo-web).",
      ],
    },
    {
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Aparecer cuando te buscan por nombre es lo mínimo. El valor está en aparecer cuando buscan lo que vendes, cosas como “imprenta de etiquetas” o “joyería de oro en Lima”, y eso no ocurre por suerte: se construye con base técnica y [trabajo de posicionamiento sostenido](/posicionamiento-seo). Al cotizar tu web, pregunta siempre qué incluye de SEO técnico; la respuesta te dirá si estás comprando presencia o solo diseño.",
      ],
    },
    {
  ...
  faq: [
    {
      q: "¿Cuánto cuesta una página web sencilla en Perú?",
      a: "Un sitio institucional hecho por un profesional se mueve entre S/ 3,500 y S/ 15,000 según diseño y alcance. Por debajo, normalmente estás comprando una plantilla adaptada, que puede ser suficiente si solo necesitas presencia.",
    },
    {
      q: "¿Cuánto cuesta el mantenimiento de una web?",
      a: "Entre hosting, dominio y actualizaciones, un sitio profesional cuesta desde unos S/ 500 a S/ 1,500 al año si es simple. Lo importante es saberlo antes de firmar: el sitio “barato” sin plan de mantenimiento suele ser el que muere en un año.",
    },
    {
      q: "¿Mi web incluirá aparecer en Google?",
      a: "Toda web seria debe incluir la base técnica: velocidad, estructura y etiquetado. El posicionamiento sostenido para búsquedas competitivas es un trabajo aparte y continuo: desconfía de quien te “garantice el primer lugar” como parte del diseño.",
    },
    {
      q: "¿Puedo actualizar el contenido yo mismo?",
      a: "Debería ser un requisito de tu compra: textos, fotos y precios editables por tu equipo sin depender de nadie. En Elaris entregamos los sitios con gestor de contenido y capacitación incluida.",
    },
  ],
