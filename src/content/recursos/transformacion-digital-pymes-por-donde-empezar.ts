...
export const article: Article = {
  slug: "transformacion-digital-pymes-por-donde-empezar",
  ...
  seoDescription:
    "Guía práctica de transformación digital para pymes: las señales de que el Excel ya no da, el orden correcto para digitalizar y los errores que cuestan caro.",
  publishDate: "2026-08-17",
  modifiedDate: "2026-08-17",
  authorSlug: "sergio-herrera",
  servicePath: "/transformacion-digital",
  ...
  faq: [
    {
      q: "¿Por dónde empiezo la transformación digital de mi pyme?",
      a: "Por un diagnóstico de cómo opera hoy tu empresa: dos semanas mirando procesos, no comprando herramientas. De ahí sale una hoja de ruta priorizada por impacto. El nuestro no tiene costo.",
    },
    {
      q: "¿Cuánto cuesta digitalizar una pyme?",
      a: "Depende del punto de partida y el alcance, pero al avanzar por fases el gasto se reparte: cada fase se cotiza cerrada y la anterior suele financiar la siguiente con las horas que recupera.",
    },
    {
      q: "¿Y si mi equipo no es tecnológico?",
      a: "Es el caso normal, no la excepción. Los sistemas se diseñan para quien los va a usar, con capacitación en cada entrega. Si el equipo no lo adopta, el proyecto falló — ese es el criterio de diseño número uno.",
    },
    {
      q: "¿Tengo que botar los sistemas que ya uso?",
      a: "No. Lo que funciona se integra; se reemplaza solo lo que te está frenando. La transformación digital seria aprovecha lo existente en vez de facturarte todo de nuevo.",
    },
  ],
