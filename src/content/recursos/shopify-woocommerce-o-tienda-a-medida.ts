...
export const article: Article = {
  slug: "shopify-woocommerce-o-tienda-a-medida",
  ...
  seoDescription:
    "Comparativa honesta para negocios en Perú: cuándo alcanza Shopify o WooCommerce y cuáles son las 5 señales de que necesitas una tienda online a medida.",
  ...
  faq: [
    {
      q: "¿Shopify o WooCommerce para empezar en Perú?",
      a: "Si quieres velocidad y cero mantenimiento, Shopify. Si quieres pagar menos al mes y tienes quién lo mantenga, WooCommerce. Para validar un negocio nuevo, cualquiera de los dos es mejor que esperar una tienda a medida.",
    },
    {
      q: "¿Cuándo conviene pasar a una tienda a medida?",
      a: "Cuando tu operación tiene reglas propias que las plataformas no entienden (inventario, cobros, integraciones) y ya pagas ese desajuste en horas de trabajo manual o ventas perdidas. Ahí la inversión inicial se recupera en operación.",
    },
    {
      q: "¿Puedo migrar de Shopify a una tienda a medida sin perder mis ventas?",
      a: "Sí. La migración se planifica con las dos tiendas conviviendo: catálogo y clientes se trasladan, las URLs importantes se redirigen y el cambio se hace sin apagar el canal de ventas.",
    },
    {
