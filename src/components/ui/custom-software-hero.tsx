...
export default function CustomSoftwareHero() {
  return (
    <section className="relative min-h-[92vh] lg:h-screen flex items-center overflow-hidden bg-gradient-to-br from-white via-[#F8FAFC] to-[#EEF3FF] pt-[40px]">
      ...
      <div className="container mx-auto px-6 max-w-7xl py-8 xl:py-10 2xl:py-16 relative z-10">
        <div className="flex flex-col lg:grid lg:grid-cols-2 lg:grid-rows-[auto_auto] gap-8 lg:gap-x-12 xl:gap-x-16 2xl:gap-x-24 lg:gap-y-6 2xl:gap-y-10 lg:items-center">
