    ...
    <div className="p-5 space-y-4">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          ...
          <div key={i} className={`${kpi.bg} border rounded-xl p-3 text-center`}>
      ...
      <div className="bg-slate-50 rounded-xl p-4 h-24 flex items-end gap-1.5 border border-slate-100">
        {[28, 45, 38, 62, 50, 75, 58, 85, 68, 92, 78, 100].map((h, i) => (
          <div
            key={i}
      ...
      <div className="space-y-2">
        {[
          ...
          <div key={i} className="flex items-center gap-3 p-2.5 bg-slate-50/80 border border-slate-100 rounded-xl">
            <div className="flex-1 min-w-0">
              ...
              <div className="w-full bg-slate-200 rounded-full h-1.5 mt-1.5">
                <div
                  className="bg-gradient-to-r from-[#2F64FF] to-[#6B9FFF] h-1.5 rounded-full transition-all"
                  style={{ width: `${row.pct}%` }}
                />
              </div>
            </div>
