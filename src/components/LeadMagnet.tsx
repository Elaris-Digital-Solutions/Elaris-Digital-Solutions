...
const WHATSAPP_URL =
  ...
  encodeURIComponent(
    "Hola Elaris, quiero el checklist «30 procesos que mi empresa puede automatizar» y un diagnóstico gratuito."
  );
  ...
  return (
    <section className="py-16 sm:py-24">
      <div className="container mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        ...
        >
          <div
            className="pointer-events-none absolute -right-16 -top-16 h-64 w-64 rounded-full bg-[#2F64FF]/20 blur-3xl"
            aria-hidden
          />
          <div className="relative grid items-center gap-10 lg:grid-cols-[1fr_auto]">
              ...
              <ul className="space-y-3">
                {copy.bullets.map((bullet) => (
                  <li key={bullet} className="flex items-start gap-3 text-sm text-white/85">
                    <span className="mt-0.5 flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-[#2F64FF]/20 text-[#7EABFF]">
            ...
            <div className="flex flex-col items-start gap-3 lg:items-center">
              <a
                ...
                className="group inline-flex items-center gap-2 whitespace-nowrap rounded-full bg-[#2F64FF] px-8 py-4 text-sm font-semibold text-white shadow-[0_12px_32px_rgba(47,100,255,0.4)] transition-all hover:-translate-y-0.5 hover:bg-[#2553e6]"
              >
                {copy.cta}
